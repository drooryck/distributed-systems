...
from . import logical_clock_pb2 as logical__clock__pb2
...
class VirtualMachineStub(object):
...
def add_VirtualMachineServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'logical_clock.VirtualMachine', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('logical_clock.VirtualMachine', rpc_method_handlers)
