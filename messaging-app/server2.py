...
class Server:
    """
    Example chat server with:
      - coarse-grained lock to prevent DB corruption
      - unique user sessions
      - new actions: logout, send_delivered_messages, and delete_messages
      - temporary reset_db action for debugging
    """
